...
HighlighterDialog::HighlighterDialog(QWidget * parent) : QDialog(parent), ui(new Ui::HighlighterDialog) {
    ui->setupUi(this);
...
void HighlighterDialog::on_comboBox_currentIndexChanged(int index) {
    ...
    switch (ui->comboBox->currentIndex())
    {
        ...
        case 1: current = &highlighter->sectionFormat; break;
        case 2: current = &highlighter->subsectionFormat; break;
        case 3: current = &highlighter->ticketFormat; break;
        case 4: current = &highlighter->questionFormat; break;
        case 5: current = &highlighter->correctAnswerFormat; break;
        case 6: current = &highlighter->incorrectAnswerFormat; break;
        case 7: current = &highlighter->priceFormat; break;
        default: qWarning("unknown index");
    }
